...
class ForwardLungesWithDumbellsWannaTry extends StatefulWidget {
  const ForwardLungesWithDumbellsWannaTry({Key? key}) : super(key: key);

  @override
  State<ForwardLungesWithDumbellsWannaTry> createState() => _DumbBellPressWannaTry();
}

class _DumbBellPressWannaTry extends State<ForwardLungesWithDumbellsWannaTry>
                    ...
                    child: Container(
                        ...
                        child: ListView(
                          children: [
                            Column(children: [
                              Text(
                                """Step-1: Inhale and take a big step forward with your right leg, landing on the heel.
