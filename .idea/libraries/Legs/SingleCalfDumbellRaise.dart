...
class SingleClafRaiseWannaTry extends StatefulWidget {
  const SingleClafRaiseWannaTry({Key? key}) : super(key: key);

  @override
  State<SingleClafRaiseWannaTry> createState() => _DumbBellPressWannaTry();
}

class _DumbBellPressWannaTry extends State<SingleClafRaiseWannaTry>
